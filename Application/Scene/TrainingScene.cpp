...
void TrainingScene::Initialize()
{
    ...
    drawSystem_->Register("TrainingScene_Particle_Compute", DrawSystem::kGPUParticleCompute, [this](const ViewProjection &vp) {
        player_ptr->DrawParticleCompute(vp);
        enemy_ptr->DrawParticleCompute(vp);
        aroundField_->DrawParticleCompute(vp);
    });
    drawSystem_->Register("TrainingScene_3D", DrawLayer::kPreEffect, [this](const ViewProjection &vp) {
    ...
    drawSystem_->Register("TrainingScene_UI", DrawLayer::kPostEffect, [this](const ViewProjection &) {
        gameUI_->Draw();
