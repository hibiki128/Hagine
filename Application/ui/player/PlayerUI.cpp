...
void PlayerUI::Update()
{
    if (pPlayer_)
    {
        ...
        float hpRatio = static_cast<float>(pPlayer_->GetHP()) / static_cast<float>(pPlayer_->GetMaxHP());
        float energyRatio = static_cast<float>(pPlayer_->GetEnergy()) / static_cast<float>(pPlayer_->GetMaxEnergy());
